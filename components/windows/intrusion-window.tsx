...
interface IntrusionWindowProps {
  id: string
  isActive: boolean
  onActivate: () => void
  onClose: () => void
...
export const IntrusionWindow = ({
  ...
  return (
    <WindowBase
      id={id}
      title="INTRUSION DETECTED :: COUNTERMEASURES REQUIRED"
      isActive={isActive}
    ...
    >
      <div className="h-full flex flex-col items-center justify-center">
        <div className="text-red-500 text-xl font-mono mb-6 animate-pulse">INTRUSION DETECTION ALERT</div>

        <div className="mb-6 text-center">
          <div className="text-neon-green/70 text-sm font-mono mb-2">ENTER COMMAND TO DISABLE SECURITY MEASURES:</div>
